...
cd ~
git clone https://github.com/shnetinka/nodejs-pool.git  # Change this depending on how the deployment goes.
cd /usr/src/gtest
sudo cmake .
sudo make
...
cd /usr/local/src
sudo git clone https://github.com/seredat/karbowanec.git
cd karbowanec
sudo make -j$(nproc)
sudo cp ~/nodejs-pool/deployment/karbowanec.service /lib/systemd/system/
sudo useradd -m karbodaemon -d /home/karbodaemon
sudo systemctl daemon-reload
sudo systemctl enable karbowanec
sudo systemctl start karbowanec
